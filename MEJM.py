...
# Datasets input
#------------------------------------------------------------------------------
End = np.copy(pd.DataFrame(pd.read_excel("C:/Users/wyx/Desktop/example.xlsx", sheet_name= 'Endpoint')))
Cov = np.copy(pd.DataFrame(pd.read_excel("C:/Users/wyx/Desktop/example.xlsx", sheet_name= 'Covariate')))
Sam = np.copy(pd.DataFrame(pd.read_excel("C:/Users/wyx/Desktop/example.xlsx", sheet_name= 'All')))
n = len(Cov[0])-1
num = 2*n+2
#------------------------------------------------------------------------------
...
# Perform optimization
best_cost, best_pos = optimizer.optimize(fun1, iters=500)
...
print('var for JM parameters: ', var)
print('CI_l for JM parameters: ', CI_l)
print('CI_h for JM parameters: ', CI_h)
